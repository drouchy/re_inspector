defmodule ReInspector.App.Workers.MessageCorrelatorWorkerTest do
  ...
  test_with_mock "launch the processing of the api request", ReInspector.App.Services.MessageCorrelationService, [process_api_request: fn(10, correlators) -> :done end] do
  ...
  test_with_mock "returns the :noreply expected by OTP", ReInspector.App.Services.MessageCorrelationService, [process_api_request: fn(10, correlators) -> :done end] do
